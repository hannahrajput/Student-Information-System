        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/Teacher.php">
              ...
              <i class="fa fa-user-circle mr-2" aria-hidden="true"></i>Teacher
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="../admin/subjects.php">
              <span data-feather="bar-chart-2"></span>
              <i class="fa fa-file-text-o mr-2" aria-hidden="true"></i>Programs
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../admin/student_result.php">
              <span data-feather="layers"></span>
              <i class="fa fa-users mr-2" aria-hidden="true"></i>Publish Results
            </a>
          </li>
          <li class="nav-item">
