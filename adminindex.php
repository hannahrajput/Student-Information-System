...
<!-- Second division-->
  ...
  <div class="col">
     <div class="login-padding" style="text-align: center; margin-top: 150px;">
                ...
                <form class="p-1" action="Login/admin_login.php" method="POST">
                    <div class="form-group">
                        <label><h6>Enter User ID:</h6></label>
                        <input type="text" name="user_id" placeholder="Enter User ID" class="form-control" required>
                    </div>
                    <div class="form-group">
                ...
                <a style="color: white;" href="index.php">Switch to Student</a>
            </div>
  </div> 
</div> 
</body>
